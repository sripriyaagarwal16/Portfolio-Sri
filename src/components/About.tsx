      ...
      <div className="section-container relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="glass-card rounded-xl p-6 opacity-0 animate-fadeIn" style={{ animationDelay: '200ms' }}>
              ...
              <ul className="space-y-4">
                ...
                <li>
                  ...
                  <p className="text-muted-foreground">Online Platform • 2022</p>
                </li>
              </ul>
            </div>
            
            <div className="glass-card rounded-xl p-6 opacity-0 animate-fadeIn" style={{ animationDelay: '300ms' }}>
              <div className="flex items-center gap-4 mb-4">
              ...
              <ul className="space-y-4">
                ...
                <li>
                  ...
                  <p className="text-muted-foreground">Company Name • 2021</p>
                </li>
              </ul>
            </div>
            
            <div className="glass-card rounded-xl p-6 opacity-0 animate-fadeIn" style={{ animationDelay: '400ms' }}>
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 rounded-lg bg-primary/10 text-primary">
                  <Heart size={24} />
                </div>
